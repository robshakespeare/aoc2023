...
public class Day12SolverTests
{
    ...
    public void Part1IndividualExamples()
    {
        ...
        RowState.Parse("???.### 1,1,3").CountPossibleArrangements().Should().Be(1);
        RowState.Parse(".??..??...?##. 1,1,3").CountPossibleArrangements().Should().Be(4);
        RowState.Parse("?#?#?#?#?#?#?#? 1,3,1,6").CountPossibleArrangements().Should().Be(1);
        RowState.Parse("????.#...#... 4,1,1").CountPossibleArrangements().Should().Be(1);
        RowState.Parse("????.######..#####. 1,6,5").CountPossibleArrangements().Should().Be(4);
        RowState.Parse("?###???????? 3,2,1").CountPossibleArrangements().Should().Be(10);
    }
